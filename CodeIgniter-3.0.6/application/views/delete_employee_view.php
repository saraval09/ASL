    ...
    <div class="row">
        ...
        <div>
            ...
            <ul class="nav nav-pills pull-right" style="margin-top:30px">
                ...
                <li class="active"> <button class="ui-state-default" onclick="window.location.href='/index.php/employee'">Add Employee</button></li>
            </ul>
            ...
            <table class="table table-striped table-hover">
                ...
                <?php for ($i = 0; $i < count($employee_list); $i++) { ?>
                    <tr>
                        ...
                        <td><a href="<?php echo base_url() . "index.php/updateEmployee/index/" . $employee_list[$i]->employee_id; ?>">Update</a></td>
                    </tr>
                <?php } ?>
                </tbody>
            </table>
